...
function is used to convert persistence data from different packages
into the `persistence` class. For example, the persistence data computed
using the **ripserr** package can be converted into the `persistence`
class as follows:
...
between two persistence diagrams. The function
