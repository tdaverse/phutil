...
{microbenchmark} package to perform benchmark tests.
...
for (dimension in seq(0, 2)) {
  ...
  bm_all <- c(bm_all, list(as.data.frame(bm_res)))
}
...
Because {microbenchmark} returns runtimes in nanoseconds, we convert these to seconds ahead of formatting the axis in seconds.
