...
#'
#' The [`persistence`] class is a list of 2-column matrices containing
#' birth-death pairs in each dimension/degree, starting with zero.
#'
#' @name persistence
#'
...
#' @returns Persistence data in the form of a list of 2-column matrices
