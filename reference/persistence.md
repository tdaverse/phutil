...
- list:
  ...
  Logical; whether to return the `diagram` object as the sole element of
  a list. Defaults to `TRUE` for consistency with the TDA package.
...
#>       dimension      Birth       Death
#>  [1,]         0 0.00000000         Inf
#>  [2,]         0 0.00000000 0.220542887
#>  [3,]         0 0.00000000 0.183721046
#>  [4,]         0 0.00000000 0.161571953
#>  [5,]         0 0.00000000 0.138728626
#>  [6,]         0 0.00000000 0.135530082
#>  [7,]         0 0.00000000 0.101384011
#>  [8,]         0 0.00000000 0.095064797
#>  [9,]         0 0.00000000 0.062636790
#> [10,]         0 0.00000000 0.014723696
#> [11,]         0 0.00000000 0.005423758
#> [12,]         0 0.00000000 0.002059914
#> [13,]         1 0.21382795 0.252023169
#> [14,]         1 0.17043368 0.207579157
#> [15,]         1 0.18158389 0.215451172
#> [16,]         1 0.30133247 0.322408606
#> [17,]         1 0.24439198 0.264181392
#> [18,]         1 0.26934253 0.286946403
#> [19,]         1 0.32881435 0.342465366
#> [20,]         1 0.25341417 0.263543342
#> [21,]         1 0.25927610 0.267734301
#> [22,]         1 0.17673254 0.179546814
#> [23,]         1 0.18487942 0.186856239
#> [24,]         1 0.22647199 0.227828650
#> [25,]         1 0.36147850 0.361518355
#> [26,]         1 0.06463873 0.064639156
#> [27,]         2 0.35599699 0.363445520
#> [28,]         2 0.31252706 0.314712773
#> [29,]         2 0.31253901 0.314339892
#> [30,]         2 0.35653366 0.356571755
#> 
( p <- as_persistence(d) )
#> 
#> ── Persistence Data ────────────────────────────────────────────────────────────
#> ℹ There are 12, 14, and 4 pairs in dimensions 0, 1, and 2 respectively.
